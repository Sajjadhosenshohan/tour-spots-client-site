        ...
        <footer className="py-6 max-w-[85%] mx-auto space-y-8 md:space-y-12 rounded-lg dark:text-white text-black">
            <div className=" px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
                ...
                <div className="flex flex-col  lg:flex-row gap-6 lg:justify-between">
                    ...
                    <div className=" items-center lg:items-start lg:w-1/2 w-full  pb-6   flex flex-col justify-evenly p-4 gap-6">
                        {/* brand */}
                        <div className="flex text-4xl items-center gap-2 font-extrabold">
                            <span className=" text-primary"><FaGlobe /></span>
                            <div className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-green-400 ">
                                GoWilds
                            </div>
                        </div>
                        ...
                        <div className="flex  space-x-4 ">
                            ...
                            <a rel="noopener noreferrer" href="https://github.com/shohan15020" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full ">
                        ...
                        <div className=" text-center md:text-left ">
                            ...
                            <ul className="mt-3 flex flex-col lg:flex-row lg:justify-between gap-3">
                                <li>
                                    <Link to="/" rel="noopener noreferrer" className="hover:dark:text-violet-600">Home</Link>
                                </li>
                                <li>
                                    <Link to="/allTour" rel="noopener noreferrer" className="hover:dark:text-violet-600">All Tourist spots</Link>
                                </li>
                                <li>
                                    <Link to="/addTour" rel="noopener noreferrer" className="hover:dark:text-violet-600">Add Tourist spots</Link>
                                </li>
                                <li>
                                    <Link to="/myList" rel="noopener noreferrer" className="hover:dark:text-violet-600">My list</Link>
                                </li>
                    ...
                    <h1 className='text-2xl md:text-4xl mx-auto  font-bold text-center mb-6 w-2/3 md:w-full '>Contact Now</h1>
