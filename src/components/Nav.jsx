...
const Nav = () => {
    ...
    const Links = <>
        ...
        <li>
            <NavLink to="/" className={({ isActive }) => isActive ? 'border-2 border-primary text-primary  font-bold ' : 'font-bold text-primary'}>Home</NavLink>

        </li>

        <li>
            <NavLink to="/allTour" className={({ isActive }) => isActive ? 'border-2 border-primary text-primary  font-bold ' : 'font-bold text-primary'}>All Tourists Spot</NavLink>
        </li>

        <li><NavLink to="/addTour" className={({ isActive }) => isActive ? 'border-2 border-primary text-primary  font-bold ' : 'font-bold text-primary'}>
            Add Tourists Spot
        </NavLink></li>

        <li><NavLink to="/myList" className={({ isActive }) => isActive ? 'border-2 border-primary text-primary  font-bold ' : 'font-bold text-primary'}>
            My List
        </NavLink></li>
            ...
            <div className="navbar top-0  sticky bg-base-100 text-base-content z-50  shadow-lg py-2 ">
                ...
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className=" menu menu-sm dropdown-content mt-3 z-[10] p-2 shadow  rounded-box w-52  bg-white">
                            {Links}
                        </ul>
                    </div>
